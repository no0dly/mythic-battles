...
const accordionContentVariants = cva(
  'overflow-hidden text-sm text-accent-foreground transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down will-change-[height]',
  {
    variants: {
      variant: {
        default: '',
