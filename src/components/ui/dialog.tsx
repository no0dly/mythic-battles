...
const PORTALED_FLOATING_CONTENT_SELECTOR =
  "[data-radix-popper-content-wrapper]";

function preventDismissOnFloatingContent(event: {
  target: EventTarget | null;
  preventDefault: () => void;
}) {
  if (
    event.target instanceof Element &&
    event.target.closest(PORTALED_FLOATING_CONTENT_SELECTOR)
  ) {
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        onPointerDownOutside={(event) => {
          preventDismissOnFloatingContent(event);
          onPointerDownOutside?.(event);
        }}
